...
public class KeyboardInputTests {
    ...
    public void nullTest() {
        assertFalse(
            ...
            kbInput.keyDown(Keys.ANY_KEY) && 
            kbInput.keyUp(Keys.ANY_KEY));
    }
    @Test
    ...
    public void keyDownTest() {
        assertTrue(
            ...
            kbInput.keyDown(Keys.LEFT) && kbInput.keyDown(Keys.A) && 
            kbInput.keyDown(Keys.UP) && kbInput.keyDown(Keys.W) && 
            kbInput.keyDown(Keys.RIGHT) && kbInput.keyDown(Keys.D) && 
            kbInput.keyDown(Keys.DOWN) && kbInput.keyDown(Keys.S) &&
    ...
    public void keyUpTest() {
        assertTrue(
            "All keys for movement and chef switching should be processed.",
            kbInput.keyUp(Keys.LEFT) && kbInput.keyUp(Keys.A)
            && kbInput.keyUp(Keys.UP) && kbInput.keyUp(Keys.W) &&
            kbInput.keyUp(Keys.RIGHT) && kbInput.keyUp(Keys.D) &&
            kbInput.keyUp(Keys.DOWN) && kbInput.keyUp(Keys.S) &&
