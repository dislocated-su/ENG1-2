...
public class FoodTextureManager implements Disposable {
    ...
    public FoodTextureManager() {
        ...
        this.foodTextures.put(
                "patty_grilled",
                new Texture(Gdx.files.internal("food/buff_chef/grilled_patty.png"))
            );
        this.foodTextures.put(
                "patty_raw",
                new Texture(Gdx.files.internal("food/buff_chef/formed_patty.png"))
            );
        this.foodTextures.put(
                "lettuce_raw",
        ...
        this.foodTextures.put(
                "lettuce_chopped",
                new Texture(Gdx.files.internal("food/buff_chef/sliced_lettuce.png"))
            );
        this.foodTextures.put(
                "tomato_raw",
        ...
        this.foodTextures.put(
                "tomato_chopped",
                new Texture(Gdx.files.internal("food/buff_chef/sliced_tomato.png"))
            );
        ...
        this.foodTextures.put(
                "jacket_potato",
                new Texture(Gdx.files.internal("food/buff_chef/jacket_potato.png"))
            );
